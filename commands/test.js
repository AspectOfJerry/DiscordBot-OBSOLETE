module.exports = {
    ...
    execute(message, args, cmd, client, Discord) {
        ...
        function banMessage(message, args, cmd, client, Discord) {

        }

        banMessage(message, args, cmd, client, Discord)
        ...
        try {
            const ban = new Discord.MessageEmbed()
                ...
                .setImage(`${memberTarget.user.avatarURL({dynamic: true, size: 64})}`)
